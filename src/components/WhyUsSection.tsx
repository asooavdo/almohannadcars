...
const FeatureCard = ({
  ...
  description,
  index
}: FeatureCardProps) => <div className="group relative luxury-card p-8 text-center hover-lift opacity-0 animate-fade-up" style={{
...
const WhyUsSection = () => {
  return <section id="why-us" className="py-24 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-gradient-to-b from-card via-background to-card" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/5 rounded-full blur-3xl" />

      <div className="container mx-auto px-4 lg:px-8 relative z-10 mb-0 mt-0 pl-0 pr-0">
        {/* Section Header */}
        ...
        <div className="text-center mt-16">
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 p-6 luxury-card">
            ...
            <a href="https://wa.me/962797055388" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-primary text-primary-foreground px-6 py-3 rounded-md font-bold hover:bg-primary/90 transition-all whitespace-nowrap">
              <span>ابدأ الآن</span>
            </a>
          </div>
        </div>
